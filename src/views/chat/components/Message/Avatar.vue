...
import defaultDsIcon from '@/assets/dsIcon.jpg'
...
<template>
  <template v-if="image">
    <!-- send的图标 -->
    <NAvatar v-if="isString(avatar) && avatar.length > 0" :src="defaultAvatar" :fallback-src="defaultAvatar" />
  ...
  <span v-else class="text-[28px] dark:text-white">
    ...
    <NAvatar :src="defaultDsIcon" :fallback-src="defaultDsIcon" />
  </span>
</template>
